...
public class ExportParameters  {
    public void test_export_parameters() {
        ...
        string sql = "select * from t where addr= \"shanghai\" and id = 3 and name = 'abc'";
    ...
    public void test_pg_export_parameters() {
        mixin(DO_TEST);
        ...
        StringBuilder _out = new StringBuilder();
        PGExportParameterVisitor visitor = new PGExportParameterVisitor(_out);
        foreach (SQLStatement stmt ; stmtList) {
            stmt.accept(visitor);
        }
